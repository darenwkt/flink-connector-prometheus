...
class RowDataElementConverterTest {
    ...
    void setUp() {
        ...
        elementConverter = new RowDataElementConverter(DATA_TYPE, prometheusConfig);
    }

    @Test
    void testApply() {
        RowData rowData = createElement();
        Types.TimeSeries actualTimeSeries = elementConverter.apply(rowData, context);
        Types.TimeSeries expectedTimeSeries =
